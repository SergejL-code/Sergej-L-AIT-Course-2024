package HomeWork_31.car_garage_31.ait.cars.test;

import HomeWork_31.car_garage_31.ait.cars.dao.Garage;
import HomeWork_31.car_garage_31.ait.cars.dao.GarageImpl;
...
class GarageImplTest {
   ...
   @Test
    ...
    @Test
    void testSortingCarByBrand() {

       Car[]cars = autos;
       Car[] expected = garage.sortingCarByModel();

     //   Car[]  =
       // Car[] actual = garage.sortingCarByModel();
        assertArrayEquals(expected,cars);
    }

    @Test
    void testSortingCarByColor() {
    }

    @Test
    void testSortingCarByCompany() {
    }
}// end of car