...
public class CompanyImpl implements Company {
    ...
    public Employee updateEmployee(Employee employee) {
        //отыскать нужного в массиве и обнавить ему поля, забирая их из employee
        for (int i = 0; i < size; i++) {
        ...
        return null;//updatete employee  не вернули
    }
 ...
 //   @Override
   // Employee[] findEmployeeHoursGreaterThan(int hours){return findEmployeeByPredicate(employee -> employee.getHours()>hours)};
   // @Override
