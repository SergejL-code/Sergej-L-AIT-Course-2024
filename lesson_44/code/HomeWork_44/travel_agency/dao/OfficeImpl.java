...
public class OfficeImpl implements Office {
    ...
    @Override
    public void printCountryRating(List<Tourist> tourists) {
//key: country, vales: frequency
        Map<String, Long> countriesByFrequency = tourists.stream()
                ...
                .collect(Collectors.groupingBy(          // группируем по названию технологии
                        ...
                        Collectors.counting()));           // считаем количество каждой технологи

        countriesByFrequency.entrySet().stream()
                .sorted((entry1, entry2) -> Long.compare(entry2.getValue(), entry1.getValue())) //
                .forEach(entry -> System.out.printf("Country: %s, Frequency: %d%n", entry.getKey(), entry.getValue()));
    }
