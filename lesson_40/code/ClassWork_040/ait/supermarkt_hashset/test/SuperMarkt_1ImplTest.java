package ClassWork_040.ait.supermarkt_hashset.test;

import ClassWork_040.ait.supermarkt_hashset.dao.SuperMarkt_1;
import ClassWork_040.ait.supermarkt_hashset.dao.SuperMarkt_1Impl;
...
LocalDate now = LocalDate.now();
    ...
    void testFindByCategory() {
        HashSet<Product_1> actual = (HashSet<Product_1>)superMarkt1.findByCategory("Bread");// безопасный кастинг
        int l = actual.size();
    ...
    void testFindProductsWithExpiredDate() {
        ...
        Iterable<Product_1> expected = Arrays.asList(product1s[4], product1s[1]);
        assertIterableEquals(actual, expected);
    }
